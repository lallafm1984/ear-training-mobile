...
const REASON_INFO: Record<UpgradeReason, {
  ...
  download_audio: {
    title: '음원 다운로드',
    description: '청음 음원(MP3) 다운로드는 Premium 플랜 전용 기능입니다.',
    requiredTier: 'premium',
    benefits: ['MP3 음원 무제한 다운로드', '음원 · 악보 이미지 무제한 저장', '음표 편집 기능 포함'],
  },
  download_image: {
    title: '악보 이미지 저장',
    description: '악보 이미지(PNG) 저장은 Premium 플랜 전용 기능입니다.',
    requiredTier: 'premium',
    benefits: ['PNG 이미지 무제한 갤러리 저장', 'MP3 음원 무제한 다운로드', '음표 편집 기능 포함'],
  },
  download_limit: {
    title: '다운로드 한도 초과',
    description: 'Pro 플랜 월 50회 한도를 모두 사용했습니다.\n무제한 다운로드는 Premium 플랜에서 가능합니다.',
    requiredTier: 'premium',
    benefits: ['음원 · 악보 무제한 다운로드', '오프라인 수업 자료 활용', '음표 편집 기능 포함'],
  },
  save_scores: {
    title: '악보 저장 한도 초과',
    description: '현재 플랜의 악보 저장 한도를 초과했습니다.\nFree: 5개 · Pro: 10개 · Premium: 30개',
    requiredTier: 'pro',
    benefits: ['Pro: 최대 10개 악보 저장', 'Premium: 최대 30개 저장', '저장된 악보 언제든 불러오기'],
  },
};
